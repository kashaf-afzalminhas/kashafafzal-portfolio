  ...
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-black">
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-3 gap-4 text-center py-8 px-4 sm:px-0">
          {skill.map(({ id, src, title, style }) => (
            <div key={id} className={`shadow-black opacity-80 hover:scale-105 duration-500 py-2 rounded-lg ${style}`}>
